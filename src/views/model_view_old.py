...
class ModelView(QWidget):
    ...
    def _setup_tabs(self):
        # Use the new BatchRunTab widget for the first tab
        self.batchrun_tab = BatchRunTab(controller=self.controller)
        self.tabs.addTab(self.batchrun_tab, "Base Models (Refactored)")
        # Keep the original tab for validation
        self.tabs.addTab(self._setup_basemodel_tab(), "Base Models (Original)")
